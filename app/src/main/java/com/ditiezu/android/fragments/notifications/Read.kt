...
class Read : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let {
            helper(it, "http://www.ditiezu.com/home.php?mod=space&do=notice&isread=1", view.findViewById(R.id.list), view.findViewById(R.id.tips), view.findViewById(R.id.tips_image))
        }
    }
}