    ...
    public void initView() {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                ImageCapture.OutputFileOptions opt = new ImageCapture.OutputFileOptions.Builder(imageOutFile).build();
                mCameraView.takePicture(opt, ContextCompat.getMainExecutor(getContext()),
